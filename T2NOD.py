...
def T2NO(input_video_name_dir='C:/Users/shash/OneDrive/Desktop/SSTA_2/simSSTA/dataset/', num_test=150, first_skip=0, thres=70., his_length=20, alg='MOG', mode='mean', vis=False, base_idx=0):
    '''
    ...
    #########################preprocessing the image from RGB to T2NOD to first obtain background image################################
                    if value_idx == 0:
                        if mode == 'static':
                            ...
                            B = cv2.imread(os.path.join('C:/Users/shash/OneDrive/Desktop/SSTA_2/simSSTA/dataset/background/',str(each_view), 'background.jpg')).astype(np.uint8)
                        ...
                        #creation of the background image
                            ...
                            cv2.imwrite('C:/Users/shash/OneDrive/Desktop/SSTA_2/simSSTA/dataset/train/background.jpg', B)
                        else:
...
if __name__ == "__main__":
    T2NO(input_video_name_dir='C:/Users/shash/OneDrive/Desktop/SSTA_2/simSSTA/dataset/',
            mode='static', num_test=150, first_skip=0, vis=False, base_idx=0, his_length=100)
