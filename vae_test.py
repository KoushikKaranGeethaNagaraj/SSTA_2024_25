...
#             tr_loss = [tensor.to("cuda:0") for tensor in tr_loss]
        ...
        if epoch % 90==0: # 20
            batch_id = 0
            res_path = os.path.join(root_res_path, "evaluating_16_16_16_16")
            res_path = os.path.join(res_path, "8")
...
if __name__ == "__main__":
    ...
    parser.add_argument('--gen_frm_dir', type=str, default= "/storage/home/hcoda1/9/knagaraj31/p-skousik3-0/SSTA_2022/model_vae")
    parser.add_argument('--num_save_samples', type=int, default=10)
    parser.add_argument('--layer_norm', type=int, default=1)
    parser.add_argument('--num_hidden', type=str, default='16,16,16,16', help='64,64,64,64')
    parser.add_argument('--filter_size', type=int, default=5)
    parser.add_argument('--stride', type=int, default=1)
    parser.add_argument('--vae_latent_dim', type=int, default=3)
    ...
    parser.add_argument('--ckpt_dir', type=str,default="/storage/home/hcoda1/9/knagaraj31/p-skousik3-0/SSTA_2022/model_vae/backup_train_vae/8", help='checkpoint dir: dir/vae.pt')
    ...
    args.train_data_paths = "/storage/home/hcoda1/9/knagaraj31/p-skousik3-0/SSTA_2022/train".format(args.data_name)
    args.valid_data_paths = "/storage/home/hcoda1/9/knagaraj31/p-skousik3-0/SSTA_2022/val".format(args.data_name)
