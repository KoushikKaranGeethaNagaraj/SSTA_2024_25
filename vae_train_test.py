...
if __name__ == "__main__":
    ...
    parser.add_argument('--mode', type=str, default="eval", help='train/continue_train / eval')
    ...
    parser.add_argument('--n_epoch', type=int, default=150, help='200')
    ...
    parser.add_argument('--valid_data_paths', type=str, default=r"DATASET\train",help='r"DATASET\val" or r"DATASET\test"')
    parser.add_argument('--display_test_images_count',type=int, default=100) 
    # RGB dataset
    ...
    parser.add_argument('--vae_save_dir', type=str, default= r"vae_sim_model_32_16_8_latent00.0000rand")
